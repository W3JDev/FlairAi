    ...
    <Modal onClose={onClose}>
      <form className="editAgent" onSubmit={handleSave}>
        ...
        <div>
          ...
          <div>
            <label htmlFor="agent-menu-description">Restaurant Knowledge Base</label>
            <textarea
              id="agent-menu-description"
              value={formState.menuDescription || ''}
              onChange={e => handleFormChange({ menuDescription: e.target.value })}
              rows={10}
